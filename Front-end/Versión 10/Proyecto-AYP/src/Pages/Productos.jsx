...
// Categorías alineadas al negocio de A&P Lubricantes y Filtros
...
function Productos({ 
  ...
  return (
    <div style={{ backgroundColor: "#F8F9FA", minHeight: "100vh" }}>
      <Navbar onOpenLogin={() => setShowModal(true)} vistaActual="productos" {...{ setVista, usuario, logout }} />
      ...
      {/* Modal de Acceso */}
      {showModal && <LoginModal onClose={() => setShowModal(false)} login={()=>{}} />}
