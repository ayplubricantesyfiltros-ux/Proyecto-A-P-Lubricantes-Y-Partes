      ...
      <div className="row g-2">
        <div className="col-md-6">
          <button 
            ...
            className="btn btn-outline-dark btn-lg w-100 rounded-pill fw-bold py-3 fs-6 d-flex align-items-center justify-content-center gap-2"
          >
        ...
        <div className="col-md-6">
          <button 
            disabled={stock === 0} 
            className="btn btn-warning btn-lg w-100 rounded-pill text-dark fw-bold py-3 fs-6"
          >
            Comprar Ahora
          </button>
        </div>
