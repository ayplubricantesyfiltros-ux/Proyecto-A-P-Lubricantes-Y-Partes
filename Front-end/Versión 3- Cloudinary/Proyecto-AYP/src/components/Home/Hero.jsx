...
// 1. ELIMINAMOS los imports locales para usar URLs de Cloudinary
// (Esto libera espacio en tu bundle de JS)
...
const SLIDES = [
  {
    ...
    accent: "#F5A623",
    // f_auto,q_auto mejora el SEO y la velocidad. El .jpg al final es la clave.
    img: "https://res.cloudinary.com/ddyrgkdxq/image/upload/v1777080505/compresor-1.jpg",
    alt: "Compresor industrial de alta potencia para operaciones de lubricantes y filtros"
  },
  {
    ...
    bg: "#F5A623",
    accent: "#fefafa",
    img: "https://res.cloudinary.com/ddyrgkdxq/image/upload/v1777080505/compresor-2.jpg",
    alt: "Mantenimiento técnico especializado para plantas eléctricas y compresores"
  },
  {
    ...
    bg: "#222831",
    accent: "#F5A623",
    img: "https://res.cloudinary.com/ddyrgkdxq/image/upload/v1777080505/compresor-3.jpg",
      ...
      <div className="carousel-inner">
        {SLIDES.map((slide, i) => (
          <div
            ...
            style={{ background: slide.bg || "#1a1a1a", minHeight: 480 }}
          >
