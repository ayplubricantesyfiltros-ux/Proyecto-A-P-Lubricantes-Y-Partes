...
const Hero = () => (
  <section
    ...
    style={{
      ...
      minHeight: '600px', // Aumentamos un poco la altura
      marginTop: '0',
    }}
  >
    {/* Overlay */}
    <div style={{
      ...
      backgroundColor: 'rgba(16, 20, 45, 0.6)', // Un azul muy oscuro para coherencia
      zIndex: 1
    }}></div>

    <div className="container text-center position-relative" style={{
      zIndex: 2,
      paddingTop: '100px' // <--- IMPORTANTE: Esto deja espacio para el Navbar
    }}>
