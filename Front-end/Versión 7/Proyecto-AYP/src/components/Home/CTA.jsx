  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        width: "100%",
        height: "100%",
        // Cambiamos la ruta local por la URL optimizada de Cloudinary
        backgroundImage: `url("https://res.cloudinary.com/ddyrgkdxq/image/upload/f_auto,q_auto/v1/cta-fondo.png")`,
